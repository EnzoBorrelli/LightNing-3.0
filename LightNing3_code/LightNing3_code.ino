...
Motor *LadoIZQ = new Motor(PWM_MOTOR_A, PIN_PWM1, PIN_MOTOR_A1, PIN_MOTOR_A2, FREQ, RES);
Motor *LadoDER = new Motor(PWM_MOTOR_B, PIN_PWM2, PIN_MOTOR_B1, PIN_MOTOR_B2, FREQ, RES);
